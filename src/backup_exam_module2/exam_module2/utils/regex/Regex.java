package backup_exam_module2.exam_module2.utils.regex;
...
public class Regex {
    ...
    public static int autoIncrementId(List<Customer> customerList){
//        if(customerList.size() == 0){
//            return 1;
//        }else {
//            return customerList.get(customerList.size()-1).getId()+1;
//        }
        return 1;
    }
